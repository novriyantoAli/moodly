...
func NewConfig() (*Config, error) {
	...
	viper.SetDefault("oauth.google.client_id", "default-google-client-id")
	viper.SetDefault("oauth.google.client_secret", "default-google-client-secret")
	viper.SetDefault("oauth.google.redirect_url", "http://localhost:8080/api/v1/oauth/callback/google")
